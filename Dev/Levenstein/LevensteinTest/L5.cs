...
namespace LevensteinTest
{
	unsafe class L5
	{
		...
		/// Конструктор
		/// </summary>
		public L5(int v_WordSimilarityKoeff, int v_WordExceedingKoeff, int v_max_transformations, int v_CHANGE, int v_ADDITION, int v_DELETION, int v_cuttingLimit)
		{
		...
		/// Конструктор
		/// </summary>
		public L5(int v_WordSimilatyKoeff, int v_WordExceedingKoeff, int v_CHANGE, int v_ADDITION, int v_DELETION, int v_cuttingLimit)
