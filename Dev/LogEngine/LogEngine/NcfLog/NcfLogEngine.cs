...
namespace LogEngine
{
    internal class NcfLogEngine : ILogEngine
    {
        ...
        private void WriteDateTime(StringBuilder sb)
        {
            ...
            sb.Append(now.Month.ToString()).Append("-");
            ...
            sb.Append(now.Day.ToString()).Append(" ");
            ...
            sb.Append(now.Hour.ToString()).Append(":");
            ...
            sb.Append(now.Minute.ToString()).Append(":");
            ...
            sb.Append(now.Second.ToString()).Append(".");
