...
{
	class SaveNclobOra2 : SaveOraTestBase
	{
		int _rowCount;
		...
		public SaveNclobOra2(string name, int iterationCount, int rowCount, string connString) : base(name, iterationCount, connString)
		{
