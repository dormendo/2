...
// Добавляет в коллекцию блок фильтра
...
// Назначает новую размерность коллекции
...
// Освобождает коллекцию блоков фильтра
...
// Возвращает блок фильтра по индексу в коллекции
