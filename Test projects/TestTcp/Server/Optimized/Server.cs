...
namespace TestTcp.Server.Sockets
{
    ...
    class SocketServer
    {
        ...
        {
            this._socketPool = new SocketPool(localEndPoint);
            // create the socket which listens for incoming connections
            listenSocket = new Socket(localEndPoint.AddressFamily, SocketType.Stream, ProtocolType.Tcp);
            listenSocket.ReceiveBufferSize = listenSocket.SendBufferSize = 200;
        ...
        public void StartAccept(SocketAsyncEventArgs acceptEventArg)
        {
            ...
            else
            {
                ...
                acceptEventArg.AcceptSocket = this._socketPool.AcquireSocket();
            }
        ...
        private void CloseClientSocket(SocketAsyncEventArgs e)
        {
            ...
            try
            {
                ...
                this._socketPool.ReleaseSocket(token.Socket);
            }
        ...
        public void Close()
        {
            Console.WriteLine("Сокетов в пуле: {0}", this._socketPool.Count);
